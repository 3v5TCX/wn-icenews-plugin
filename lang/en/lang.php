...
return [
    'plugin' => [
        'name' => 'News',
        'description' => 'A robust newsging platform.',
    ],
    'news' => [
        'menu_label' => 'News',
        'menu_description' => 'Manage News Posts',
        'posts' => 'Posts',
        'create_post' => 'news post',
        'categories' => 'Categories',
        'create_category' => 'news category',
        'access_posts' => 'Manage the news posts',
        'access_categories' => 'Manage the news categories',
        'access_other_posts' => 'Manage other users news posts',
    ...
    'posts' => [
        'list_title' => 'Manage the news posts',
        'category' => 'Category',
    ...
    'post' => [
        ...
        'categories_comment' => 'Select categories the news post belongs to',
    ...
    'settings' => [
        ...
        'category_description' => 'Displays a list of news categories on the page.',
        'category_slug' => 'Category slug',
        'category_slug_description' => "Look up the news category using the supplied slug value. This property is used by the default component partial for marking the currently active category.",
        ...
        'post_slug' => 'Post slug',
        'post_slug_description' => "Look up the news post using the supplied slug value.",
        ...
        'posts_description' => 'Displays a list of latest news posts on the page.',
        ...
        'posts_no_posts_description' => 'Message to display in the news post list in case if there are no posts. This property is used by the default component partial.',
        ...
        'posts_post_description' => 'Name of the news post page file for the "Learn more" links. This property is used by the default component partial.',
    ],
];
