<?php namespace IceCollection\News\Classes;

/**
 * News Markdown tag processor.
 *
 * @package icecolection\news
...
class TagProcessor
{
    ...
    /**
     * Registers a callback function that handles news post markup.
     ...
     * the function should return a markup for the news post preview form or for the
     * front-end.
